...
ConVar r_drawstring_max_string_length("r_drawstring_max_string_length", 65536, FCVAR_NONE, "maximum number of characters per call, sanity/memory buffer limit");
