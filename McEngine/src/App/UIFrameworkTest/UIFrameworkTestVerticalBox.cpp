...
{
	m_boxNormal = std::shared_ptr<CBaseUIContainerVerticalBox>((new CBaseUIContainerVerticalBox)
			->setPos(50, 350)
			->setSize(100, 600)
			->setAnchor(0, 0.5)
			->setName("NormalBox")
	...
	m_boxWithPadding = std::shared_ptr<CBaseUIContainerVerticalBox>((new CBaseUIContainerVerticalBox)
				->setPos(300, 350)
				->setSize(100, 600)
				->setAnchor(0, 0.5)
				->setName("PaddedBox")
	...
	m_boxHeightOverride = std::shared_ptr<CBaseUIContainerVerticalBox>((new CBaseUIContainerVerticalBox)
				->setPos(550, 350)
				->setSize(100, 600)
				->setAnchor(0, 0.5)
	...
	m_boxSizeByHeightOnly = std::shared_ptr<CBaseUIContainerVerticalBox>((new CBaseUIContainerVerticalBox)
				->setPos(800, 350)
				->setSize(100, 600)
				->setAnchor(0, 0.5)
	...
	m_boxNormalLabel = std::make_shared<CBaseUILabel>(100, 25, 0, 0, "NormalLabel", "Normal");
	m_boxNormalLabel
					->setAnchor(0.5, 0)
	...
	m_boxWithPaddingLabel = std::make_shared<CBaseUILabel>(350, 675, 0, 0, "PaddingLabel", "Padding: 10 - Margin: (10, 20)");
	...
	m_boxHeightOverrideLabel = std::make_shared<CBaseUILabel>(600, 25, 0, 0, "HeightOverrideLabel", "Padding: 10 - Margin: 10 - Height Override");
...
void UIFrameworkTestVerticalBox::addElement()
{
	...
	m_boxHeightOverride->addElement((new CBaseUITextbox)
								   ->setText(text)
								   ->setName(name)
								   ->setTextJustification(1)
								   ->setRelSizeY(0.1));
