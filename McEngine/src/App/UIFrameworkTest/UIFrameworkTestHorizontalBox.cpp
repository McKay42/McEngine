...
{
	m_boxNormal = std::shared_ptr<CBaseUIContainerHorizontalBox>((new CBaseUIContainerHorizontalBox)
			->setPos(550, 25)
			->setSize(600, 100)
			->setAnchor(0.5, 0)
			->setName("NormalBox")
	...
	m_boxWithPadding = std::shared_ptr<CBaseUIContainerHorizontalBox>((new CBaseUIContainerHorizontalBox)
				->setPos(550, 200)
				->setSize(600, 100)
				->setAnchor(0.5, 0)
				->setName("PaddedBox")
	...
	m_boxWidthOverride = std::shared_ptr<CBaseUIContainerHorizontalBox>((new CBaseUIContainerHorizontalBox)
				->setPos(550, 375)
				->setSize(600, 100)
				->setAnchor(0.5, 0)
	...
	m_boxSizeByHeightOnly = std::shared_ptr<CBaseUIContainerHorizontalBox>((new CBaseUIContainerHorizontalBox)
				->setPos(550, 550)
				->setSize(600, 100)
				->setAnchor(0.5, 0)
	...
	m_boxNormalLabel = std::make_shared<CBaseUILabel>(550, 0, 0, 0, "NormalLabel", "Normal");
	m_boxNormalLabel
					->setAnchor(0.5, 0)
	...
	m_boxWithPaddingLabel = std::make_shared<CBaseUILabel>(550, 175, 0, 0, "PaddingLabel", "Padding: 10 - Margin: (20, 10)");
	...
	m_boxWidthOverrideLabel = std::make_shared<CBaseUILabel>(550, 350, 0, 0, "WidthOverrideLabel", "Padding: 10 - Margin: 10 - Width Override");
	...
	m_resizeBoxesHeight = std::make_shared<CBaseUIButton>(1000, 100, 200, 25, "ResizeHeightButton", "Resize Height");
	m_resizeBoxesHeight->setClickCallback(fastdelegate::MakeDelegate(this, &UIFrameworkTestHorizontalBox::resizeBoxesHeight));

	m_resizeBoxesWidth = std::make_shared<CBaseUIButton>(1000, 200, 200, 25, "ResizeWidthButton", "Resize Width");
	m_resizeBoxesWidth->setClickCallback(fastdelegate::MakeDelegate(this, &UIFrameworkTestHorizontalBox::resizeBoxesWidth));

	m_addElement = std::make_shared<CBaseUIButton>(1000, 300, 200, 25, "AddElementButton", "Add Element");
	m_addElement->setClickCallback(fastdelegate::MakeDelegate(this, &UIFrameworkTestHorizontalBox::addElement));

	m_removeElement = std::make_shared<CBaseUIButton>(1000, 400, 200, 25, "RemoveElementButton", "Remove Element");
...
void UIFrameworkTestHorizontalBox::addElement()
{
	...
	m_boxNormal->addElement((new CBaseUITextbox)
							->setText(text)
							->setName(name)
							->setTextJustification(1));

	sprintf(name, "Padded%i", m_elementCount);
	m_boxWithPadding->addElement((new CBaseUITextbox)
								 ->setText(text)
								 ->setName(name)
								 ->setTextJustification(1));

	sprintf(name, "WidthOverride%i", m_elementCount);
	m_boxWidthOverride->addElement((new CBaseUITextbox)
								   ->setText(text)
								   ->setName(name)
								   ->setTextJustification(1)
								   ->setRelSizeX(0.1));
	...
	m_boxSizeByHeightOnly->addElement((new CBaseUITextbox)
									  ->setText(text)
									  ->setName(name)
									  ->setTextJustification(1)
									  ->setRelSizeX(0.3));
